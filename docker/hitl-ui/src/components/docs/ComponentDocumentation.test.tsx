...
// Loading components
import { LoadingSpinner, LoadingOverlay, SkeletonCard, SkeletonLine } from '../common/LoadingStates';
...
import { GateTypeBadge, GateStatusBadge } from '../gates/GateBadge';
import FeedbackCapture from '../gates/FeedbackCapture';
import RuleProposalCard from '../gates/RuleProposalCard';
